...
- **Optimized memory allocation** - The library inherits the [bVariant library](https://github.com/diy365-mgos/bvar) optimized memory allocation. In addition, blocks of dictionary's items are automatically allocated and disposed to prevent memory fragmentation.
